...
const COLORS = ['#10b981', '#f59e0b', '#334155']; // 기간제(초록), 시간제(주황), 기타(어두운회색)
...
const MemberStatusChart = () => {
    ...
    // 기타 회원 = 전체 - (기간제 + 시간제)
    const otherMembers = stats.total_members - stats.period_members - stats.time_members;
    
    const chartData = [
        { name: '기간권', value: stats.period_members },
        { name: '시간권', value: stats.time_members },
        { name: '기타', value: otherMembers > 0 ? otherMembers : 0 },
    ];
        ...
        <div className="bg-[#1e293b] p-6 rounded-xl border border-slate-700/50 shadow-lg h-80 flex flex-col relative overflow-hidden">
            ...
            <div className="flex justify-between items-start mb-2 z-10 shrink-0">
                ...
                <div className="text-right">
                    ...
                    <p className="text-2xl font-bold text-slate-200 leading-none">{stats.total_members.toLocaleString()}</p>
                </div>
            </div>
            ...
            <div className="flex flex-1 items-center min-h-0">
                ...
                <div className="w-1/2 h-full relative">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                        ...
                        <div className="flex items-center gap-1.5">
                            ...
                            <span className="text-2xl font-bold text-white">{stats.current_users}</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="w-1/2 flex flex-col justify-center gap-3 pl-4 z-10 border-l border-slate-700/30 min-w-0">
                    ...
                    <div className="group flex justify-between items-center">
                        ...
                        <span className="text-base font-bold text-slate-200">{stats.period_members.toLocaleString()}</span>
                    </div>
                    ...
                    <div className="group flex justify-between items-center">
                        ...
                        <span className="text-base font-bold text-slate-200">{stats.time_members.toLocaleString()}</span>
                    </div>
                    ...
                    <div className="group flex justify-between items-center">
                        ...
                        <span className="text-base font-bold text-blue-400">+{stats.new_members}</span>
                    </div>
                    ...
                    <div className="group flex justify-between items-center">
                        ...
                        <span className="text-base font-bold text-purple-400">{stats.non_members}</span>
                    </div>
