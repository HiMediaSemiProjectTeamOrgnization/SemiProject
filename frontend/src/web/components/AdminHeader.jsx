...
function AdminHeader() {
    ...
    return (
        <header className="h-20 bg-[#0f172a] border-b border-slate-700/50 flex items-center justify-between px-8 z-20 flex-shrink-0">
            <div>
                <h2 className="text-2xl font-bold text-white tracking-tight">대시보드</h2>
